...
{:else if variant === 'Outline'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.1108 17.61C13.9208 17.61 13.7308 17.54 13.5808 17.39C13.2908 17.1 13.2908 16.62 13.5808 16.33L16.6208 13.29C16.9108 13 17.3908 13 17.6808 13.29C17.9708 13.58 17.9708 14.06 17.6808 14.35L14.6408 17.39C14.5008 17.53 14.3108 17.61 14.1108 17.61Z" fill={`${color}`}/>
<path d="M17.1498 14.5701H6.83984C6.42984 14.5701 6.08984 14.2301 6.08984 13.8201C6.08984 13.4101 6.42984 13.0701 6.83984 13.0701H17.1498C17.5598 13.0701 17.8998 13.4101 17.8998 13.8201C17.8998 14.2301 17.5698 14.5701 17.1498 14.5701Z" fill={`${color}`}/>
...
<path d="M17.1498 10.9299H6.83984C6.42984 10.9299 6.08984 10.5899 6.08984 10.1799C6.08984 9.76993 6.42984 9.42993 6.83984 9.42993H17.1498C17.5598 9.42993 17.8998 9.76993 17.8998 10.1799C17.8998 10.5899 17.5698 10.9299 17.1498 10.9299Z" fill={`${color}`}/>
