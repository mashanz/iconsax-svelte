...
{:else if variant === 'Outline'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path d="M3.27094 20.4499C3.08094 20.4499 2.89094 20.3799 2.74094 20.2299C2.45094 19.9399 2.45094 19.4599 2.74094 19.1699L19.1909 2.71994C19.4809 2.42994 19.9609 2.42994 20.2509 2.71994C20.5409 3.00994 20.5409 3.48994 20.2509 3.77994L3.80094 20.2299C3.66094 20.3799 3.47094 20.4499 3.27094 20.4499Z" fill={`${color}`} />
		<path d="M16.0605 18.75C15.6505 18.75 15.3105 18.41 15.3105 18V13C15.3105 12.59 15.6505 12.25 16.0605 12.25C16.4705 12.25 16.8105 12.59 16.8105 13V18C16.8105 18.41 16.4705 18.75 16.0605 18.75Z" fill={`${color}`} />
		<path d="M18.5 16.25H13.5C13.09 16.25 12.75 15.91 12.75 15.5C12.75 15.09 13.09 14.75 13.5 14.75H18.5C18.91 14.75 19.25 15.09 19.25 15.5C19.25 15.91 18.91 16.25 18.5 16.25Z" fill={`${color}`} />
