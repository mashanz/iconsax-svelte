...
{:else if variant === 'Bold'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path d="M12.93 4.78906H7.35C3.25 4.78906 2 6.03906 2 10.1391V13.8591C2 17.9591 3.25 19.2091 7.35 19.2091H12.93C17.03 19.2091 18.28 17.9591 18.28 13.8591V10.1391C18.28 6.03906 17.03 4.78906 12.93 4.78906ZM7.1 14.1791C7.02 14.5191 6.71 14.7491 6.37 14.7491C6.31 14.7491 6.25 14.7391 6.19 14.7291C5.79 14.6291 5.54 14.2191 5.64 13.8191C5.94 12.6291 5.94 11.3691 5.64 10.1791C5.54 9.77906 5.78 9.36906 6.19 9.26906C6.6 9.16906 7 9.41906 7.1 9.81906C7.46 11.2491 7.46 12.7491 7.1 14.1791ZM10.6 14.1791C10.52 14.5191 10.21 14.7491 9.87 14.7491C9.81 14.7491 9.75 14.7391 9.69 14.7291C9.29 14.6291 9.04 14.2191 9.14 13.8191C9.44 12.6291 9.44 11.3691 9.14 10.1791C9.04 9.77906 9.28 9.36906 9.69 9.26906C10.09 9.16906 10.5 9.40906 10.6 9.81906C10.96 11.2491 10.96 12.7491 10.6 14.1791Z" fill={`${color}`} />
	</svg>
