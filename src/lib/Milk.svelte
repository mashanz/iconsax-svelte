...
<path d="M18 16.75C17.59 16.75 17.25 16.41 17.25 16V15C17.25 14.59 17.59 14.25 18 14.25C18.41 14.25 18.75 14.59 18.75 15V16C18.75 16.41 18.41 16.75 18 16.75Z" fill={`${color}`}/>
<path d="M6 15.73C5.59 15.73 5.25 15.39 5.25 14.98V13.98C5.25 13.57 5.59 13.23 6 13.23C6.41 13.23 6.75 13.57 6.75 13.98V14.98C6.75 15.39 6.41 15.73 6 15.73Z" fill={`${color}`}/>
<path d="M14.5 5.75H9.5C8.26 5.75 7.25 4.74 7.25 3.5C7.25 2.26 8.26 1.25 9.5 1.25H14.5C15.74 1.25 16.75 2.26 16.75 3.5C16.75 4.74 15.74 5.75 14.5 5.75ZM9.5 2.75C9.09 2.75 8.75 3.09 8.75 3.5C8.75 3.91 9.09 4.25 9.5 4.25H14.5C14.91 4.25 15.25 3.91 15.25 3.5C15.25 3.09 14.91 2.75 14.5 2.75H9.5Z" fill={`${color}`}/>
</svg>
