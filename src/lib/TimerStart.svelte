...
{:else if variant === 'Outline'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path d="M16.1504 22.0201C15.8004 22.0201 15.4804 21.9401 15.1904 21.7701C14.5304 21.3901 14.1504 20.6201 14.1504 19.6601V17.3501C14.1504 16.3901 14.5304 15.6201 15.1904 15.2401C15.8504 14.8601 16.7004 14.9201 17.5304 15.3901L19.5304 16.5501C20.3604 17.0301 20.8404 17.7401 20.8404 18.5001C20.8404 19.2601 20.3604 19.9701 19.5304 20.4501L17.5304 21.6101C17.0704 21.8801 16.6004 22.0201 16.1504 22.0201ZM16.1604 16.4801C16.0804 16.4801 16.0004 16.5001 15.9404 16.5301C15.7604 16.6301 15.6504 16.9401 15.6504 17.3401V19.6501C15.6504 20.0501 15.7604 20.3601 15.9404 20.4601C16.1204 20.5601 16.4404 20.5101 16.7804 20.3101L18.7804 19.1501C19.1304 18.9501 19.3404 18.7001 19.3404 18.5001C19.3404 18.3001 19.1304 18.0501 18.7804 17.8501L16.7804 16.6901C16.5504 16.5501 16.3304 16.4801 16.1604 16.4801Z" fill={`${color}`} />
	</svg>
