...
{:else if variant === 'Outline'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path d="M5 22.75C3.34 22.75 1.78 21.87 0.940002 20.44C0.490002 19.72 0.25 18.87 0.25 18C0.25 15.38 2.38 13.25 5 13.25C7.62 13.25 9.75 15.38 9.75 18C9.75 18.87 9.51 19.72 9.06 20.45C8.22 21.87 6.66 22.75 5 22.75ZM5 14.75C3.21 14.75 1.75 16.21 1.75 18C1.75 18.59 1.90997 19.17 2.21997 19.67C2.79997 20.65 3.87 21.25 5 21.25C6.13 21.25 7.20003 20.65 7.78003 19.68C8.09003 19.17 8.25 18.6 8.25 18C8.25 16.21 6.79 14.75 5 14.75Z" fill={`${color}`} />
		<path d="M2.24948 21.5C2.05948 21.5 1.86945 21.43 1.71945 21.28C1.42945 20.99 1.42945 20.5099 1.71945 20.2199L7.21945 14.7199C7.50945 14.4299 7.98951 14.4299 8.27951 14.7199C8.56951 15.0099 8.56951 15.49 8.27951 15.78L2.77951 21.28C2.62951 21.43 2.43948 21.5 2.24948 21.5Z" fill={`${color}`} />
	</svg>
