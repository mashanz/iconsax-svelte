...
<path d="M21 22.75H18C17.59 22.75 17.25 22.41 17.25 22C17.25 21.59 17.59 21.25 18 21.25H20.25V19C20.25 18.59 20.59 18.25 21 18.25C21.41 18.25 21.75 18.59 21.75 19V22C21.75 22.41 21.41 22.75 21 22.75Z" fill={`${color}`}/>
<path d="M20.9595 22.7099C20.7695 22.7099 20.5795 22.6399 20.4295 22.4899L14.4695 16.5299C14.1795 16.2399 14.1795 15.7599 14.4695 15.4699C14.7595 15.1799 15.2395 15.1799 15.5295 15.4699L21.4895 21.4299C21.7795 21.7199 21.7795 22.1999 21.4895 22.4899C21.3395 22.6299 21.1495 22.7099 20.9595 22.7099Z" fill={`${color}`}/>
</svg>
