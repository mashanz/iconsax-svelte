...
<path d="M7.9707 22.75C7.5607 22.75 7.2207 22.41 7.2207 22V2C7.2207 1.59 7.5607 1.25 7.9707 1.25C8.3807 1.25 8.7207 1.59 8.7207 2V22C8.7207 22.41 8.3907 22.75 7.9707 22.75Z" fill={`${color}`}/>
