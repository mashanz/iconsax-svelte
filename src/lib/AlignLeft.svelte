...
<path d="M5 22.7402C4.59 22.7402 4.25 22.4002 4.25 21.9902V1.99023C4.25 1.58023 4.59 1.24023 5 1.24023C5.41 1.24023 5.75 1.58023 5.75 1.99023V21.9902C5.75 22.4002 5.41 22.7402 5 22.7402Z" fill={`${color}`}/>
</svg>
