...
<path d="M14.9707 22.75C14.5607 22.75 14.2207 22.41 14.2207 22V2C14.2207 1.59 14.5607 1.25 14.9707 1.25C15.3807 1.25 15.7207 1.59 15.7207 2V22C15.7207 22.41 15.3907 22.75 14.9707 22.75Z" fill={`${color}`}/>
