...
{:else if variant === 'Outline'}
	<svg width={`${size}`} height={`${size}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path d="M12.9997 22.75H10.9997C8.95972 22.75 7.65972 21.77 7.32972 19.99C7.25972 19.58 7.51972 19.19 7.92972 19.12C8.32972 19.04 8.72972 19.31 8.79972 19.72C8.92972 20.43 9.29972 21.25 10.9897 21.25H12.9897C14.5697 21.25 15.2397 20.58 15.2397 19V15.75H12.9597C12.5497 15.75 12.2097 15.41 12.2097 15C12.2097 14.59 12.5497 14.25 12.9597 14.25H15.9997C16.4097 14.25 16.7497 14.59 16.7497 15V19C16.7497 21.42 15.4197 22.75 12.9997 22.75Z" fill={`${color}`} />
		<path d="M6 18.75C3.58 18.75 2.25 17.42 2.25 15V10C2.25 7.58 3.58 6.25 6 6.25H16.59C17 6.25 17.34 6.59 17.34 7C17.34 7.41 17 7.75 16.59 7.75H6C4.42 7.75 3.75 8.42 3.75 10V15C3.75 16.58 4.42 17.25 6 17.25C6.41 17.25 6.75 17.59 6.75 18C6.75 18.41 6.41 18.75 6 18.75Z" fill={`${color}`} />
		<path d="M18 18.7501H16C15.59 18.7501 15.25 18.4101 15.25 18.0001V15.7501H13C12.59 15.7501 12.25 15.4101 12.25 15.0001C12.25 14.5901 12.59 14.2501 13 14.2501H16C16.41 14.2501 16.75 14.5901 16.75 15.0001V17.2501H18C19.58 17.2501 20.25 16.5801 20.25 15.0001V10.0001C20.25 9.08007 20.02 8.47007 19.54 8.13007C19.2 7.89007 19.12 7.42007 19.36 7.09007C19.6 6.75007 20.07 6.67007 20.41 6.91007C21.3 7.54007 21.75 8.58007 21.75 10.0001V15.0001C21.75 17.4201 20.42 18.7501 18 18.7501Z" fill={`${color}`} />
		<path d="M17 15.75H15.79C15.38 15.75 15.04 15.41 15.04 15C15.04 14.59 15.38 14.25 15.79 14.25H17C17.41 14.25 17.75 14.59 17.75 15C17.75 15.41 17.41 15.75 17 15.75Z" fill={`${color}`} />
		<path d="M9 11.75H7C6.59 11.75 6.25 11.41 6.25 11C6.25 10.59 6.59 10.25 7 10.25H9C9.41 10.25 9.75 10.59 9.75 11C9.75 11.41 9.41 11.75 9 11.75Z" fill={`${color}`} />
